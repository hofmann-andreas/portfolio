  ...
  return (
    <FormFieldWrapper error={error} label={label} id={rest.id}>
      <input
        ...
        className={clsx(
          "w-full resize-none rounded border bg-white px-4 py-2.5 transition-colors placeholder:text-muted-foreground/50 focus:ring-2 focus:outline-none dark:bg-input-background",
          {
